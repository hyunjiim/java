...
public class DoubleArrayApp {
	public static void main(String[] args) {
		...
		System.out.println("num[0][1]= "+num[1][0]);
		System.out.println("num[0][2]= "+num[1][0]);
		
		System.out.println("num[1][0]= "+num[1][0]);
		System.out.println("num[1][1]= "+num[1][0]);
		System.out.println("num[1][2]= "+num[1][0]);
		...
		System.out.println("==========================================================");
		for(int i=0;i<num.length;i++) {//1차원 배열(행)을 일괄처리하기 위한 반복문
		...
		//단순형: int[][] su={{10,20,30,},{40,50,60},{70,80,90}};
		for(int[] array:su) {
			for(int temp: array) {
