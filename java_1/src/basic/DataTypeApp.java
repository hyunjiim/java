...
public class DataTypeApp {
	public static void main(String[] args) {
		...
		System.out.println("정수형(8진수 100) = "+0100); //8진수 정수형 리터럴 출력
		System.out.println("정수형(16진수 100) = "+0x100);  //16진수 정수형 리터럴 출력
		System.out.println("정수형(10진수 100) = "+100L); //10진수 정수형 리터럴(8Byte-LongType) 출력
		...
		System.out.println("실수형(8Byte) = "+0.00000000123); //실수값 >>8Byte 실수형 리터럴(DoubleType))
		System.out.println("실수형(8Byte) = "+1.23E+10);
