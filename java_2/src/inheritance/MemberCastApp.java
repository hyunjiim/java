...
public class MemberCastApp {
	public static void main(String[] args) {
		...
		*/
		...
		//묵시적 객체 형변환: 부모클래스의 메소드를 자식클래스에서 오버라이드 선언하면 부모클래스의 숨겨진 매소드 대신 자식클래스의 메소드를 호출하기 위해 참조변수의 자료형을 자동으로 자식클래스로 변경하여 일시적으로 자식클래스의 객체가 참조변수에 저장되어 자식 클래스의 메소드 호출 
		member4.display();
		System.out.println("=======================================================");
	}
}
