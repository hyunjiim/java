...
//=>두 개의 클래스가 밀접한 관계에 있을 때 사용 - 클래스의 캡슐화를 강화할 목적으로 선언


public class OuterOne {	//OuterClass
	...
	public void outerDisplay() {
		...
		//외부클래스에서는 객체 내부클래스의 필드 또는 메소드에 직접 참조 불가능
	...
	//=>객체 내부 클래스에서는 static 제한자를 사용하여 필드 또는 메소드 선언 불가
