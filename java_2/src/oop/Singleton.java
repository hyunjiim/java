...
public class Singleton {
	...
	//=>static으로 선언되어야지만 싱글톤 클래스를 만들 수 있음
	//어떤 경우라도 1개의 객체만 생성해야 함
	//=>내부적으로 하나의 객체만 보장하기 위해 자체 객체를 저장하는 참조체 선언
	...
	//정적 영역(Static Block): 클래스를 읽어 메모리(MethodArea)에 저장된 후 자동으로 실행될 명령을 작성하기 위한 명령
	//프로그램에서 한번만 실행되는 명령
