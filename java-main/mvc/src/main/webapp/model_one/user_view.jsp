...
<table width=780 border=0 cellpadding=0 cellspacing=0>
	<tr>
	  ...
	  <table width=590 border=0 cellpadding=0 cellspacing=0>
		  <tr>
			<td bgcolor="f4f4f4" height="22">&nbsp;&nbsp;<b>íìê´ë¦¬ - íìì ë³´</b></td>
		  </tr>
	  </table>  
	  <br>
	  ...
	  <table border="0" cellpadding="0" cellspacing="1" width="590" bgcolor="BBBBBB">
		  ...
		  <tr>
			<td width=100 align=center bgcolor="E6ECDE" height="22">ì´ë©ì¼</td>
			<td width=490 bgcolor="ffffff"  style="padding-left:10px;">
				abc@daum.net
			</td>
		  </tr>		  
	  ...
	  <table width=590 border=0 cellpadding=0 cellspacing=0>
		  <tr>
			...
			<input type="button" value="수정" onClick="location.href='user_modify.jsp?userid=<%=loginUserinfo.getUserid()%>';">
