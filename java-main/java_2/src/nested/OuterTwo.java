...
//정적 내부클래스에서는 외부 클래스의 필드 또는 메소드 참조 불가능
//=>외부클래스의 정적필드 또는 정적메소드는 참조 가능
//외부클래스는 정적 내부클래스로 객체를 생성하여 접근 제한자에 상관없이 정적 내부 클래스의 필드 또는 메소드 참조 가능
//외부클래스에서는 정적 내부클래스를 사용하여 정적필드 또는 정적 메소드 접근 가능
