...
public class CarApp {
	public static void main(String[] args) {
		...
		//=> 클래스는 객체를 생성하기 위한틀(Template)
		//=> 객체를 생성하면 객체의 필드에서는 기본값(숫자형: 0, 논리형: false,
		//	참조형: null)이 초기값으로 자동 저장
		Car carOne = new Car(); //modelName=null, engineStatus=false, currentSpeed=0
		Car carTwo = new Car(); //modelName=null, engineStatus=false, currentSpeed=0
		Car carThree = new Car(); //modelName=null, engineStatus=false, currentSpeed=0
