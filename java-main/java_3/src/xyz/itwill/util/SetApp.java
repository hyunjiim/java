...
//콜렉션 클래스(Collection Class):자료구조(Data Structure)를 사용하여 객체를 효율적으로 관리(추가,삭제,검색)하기 위한 기능을 제공하는 데이터 수집 클래스들을 표현
...
public class SetApp{
	public static void main(String[] args) {
		...
		//=>HashSet 클래스에 제네릭 타입에 전달된 클래스의 객체만 저장 가능
		...
		//요소(Element): 컬렉션 클래스의 객체에 저장되는 객체
		set.add("홍길동");
		set.add("임꺽정");
		set.add("전우치");
