...
public class DecimalFormatApp {
	public static void main(String[] args) {
		...
		//DcimalFormat.format(long number): 숫자값을 전달받아 DecimalFormat 객체에 저장된 패턴정보를 사용하여 문자열로 변환하여 반환하는 메소드
		System.out.println("금액= "+decimalFormat.format(money)+"원");
		
		//DcimalFormat.getInstance(): 기본 패턴정보가 저장된 DecimalFormat 객체를 반환하는 메소드
		...
		System.out.println("금액= "+decimalFormat.getCompactNumberInstance().format(money)+"원");
	}
}
