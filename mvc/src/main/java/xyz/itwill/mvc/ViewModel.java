...
//클라이언트가 [/view.do]로 요청한 경우 객체로 생성될 모델 역할의 클래스
...
public class ViewModel implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			//UserinfoService 클래스의 getUserinfo(String userid) 메소드를 호출하여 검색된 회원정보를
			//DTO 객체로 반환받아 request 객체의 속성값으로 저장
			// => UserinfoService 클래스의 getUserinfo(String userid) 메소드를 호출하여 검색된 회원정보가
