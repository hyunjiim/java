...
<body>
	...
	<%-- pageContext 내장객체 - PageContext 객체: 웹프로그램 작성에 필요한 모든 정보를 저장한 객제 --%>
	<%-- pageContext.getRequest(): 요청정보가 저장된 ServletRequest 객체를 반환하는 메소드 --%>
	<%-- => ServletRequest 객체를 HttpServletRequest 객체(자식)로 형변환 가능 --%>
	<%-- 요청된 Request 객체가 없으면? --%>
	...
	<%-- => EL 표현식에서 pageContext 내장객체로 JSP 의 pageContext 내장객체의 메소드 호출 가능 --%>
