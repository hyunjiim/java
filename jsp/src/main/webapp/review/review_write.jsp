...
<%-- => [review_datail.jsp] 문서에서 부모 게시글 관련 정보(ref, restep, relevel, pageNum) 전달 --%>

<%-- 비로그인 상태의 사용자가 JSP 문서를 요청한 경우 에러페이지로 이동되도록 응답 처리 - include 사용 --%>
<%-- [login_check.jspf]파일에서 제공받은 loginMember 객체 사용 가능 --%>
