...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%-- 로그인 정보(아이디,비밀번호)를 전달받아 MEMBER 테이블에 저장된 회원정보와 비교하여 로그인 처리하고
[main/main_page.jsp] 문서를 요청하기 위한 URL 주소를 전달하여 응답하는 JSP 문서 --%>
<%-- => 전달받은 로그인 정보를 인증이 실패한 경우 [member/member_login.jsp] 문서를 요청하기 위한 URL 주소를 전달 --%>
<%
	...
	//검색된 회원정보가 없거나 검색된 회원정보의 비밀번호와 입력되어 전달된 비밀번호를 비교하여 다른 경우 - 인증 실패
	if(member==null){
