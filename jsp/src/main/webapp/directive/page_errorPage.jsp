<%-- errorPage 속성이 [web.xml]에 작성된 에러처리 명령보다 우선순위가 높음 --%>
...
<%-- => 프로젝트에서 작성된 모든 웹프로그램 실행시 발생되는 에러코드 대신 에러페이지로 응답처리 가능 --%>
...
<body>
	...
	<hr>
	<p>page Directive의 errorPage 속성에는 JSP 문서 실행시 에러(예외)가 발생될 경우 클라이언트에
