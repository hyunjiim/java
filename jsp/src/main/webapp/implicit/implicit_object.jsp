...
<body>
	...
	<p><span>request(HttpServletRequest)</span>: 클라이언트의 요청정보를 제공하기 위한 객체</p>
	<p><span>response(HttpServletResponse)</span>: 클라이언트의 응답정보를 제공하기 위한 객체</p>
	...
	<%-- 세션객체는 클라이언트에 따라 다르며 로그인과 관련해 클라이언트마다 다른 권한 관련 정보가 저장된 객체를 저장하여 권한관련
	 처리하기 위해 사용--%>
	<p><span>session(HttpSession)</span>: 서버와 클라이언트의 연결 지속성을 제공하기 위한 객체</p>
