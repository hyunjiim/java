...
<body>
	...
	/*
	//페이지에서 검색된 태그를 Element 객체로 제공받아 Click 이벤트가 발생될 경우 호출될 이벤트 처리 함수 등록
	...
	*/
	...
	document.getElementById("btn1").onclick= function() {
		...
		//XMLHttpRequest.onreadystatechange: XMLHttpRequest 객체의 준비상태가 변경되는 이벤트에 대한 
		//이벤트 리스너 속성(프로퍼티)
		...
		// => url: 요청 웹프로그램의 URL 주소 전달 - 현재 서버에 존재하는 웹프로그램만 요청 가능
