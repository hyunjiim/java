...
public class JoinPointAdvice {
	...
	//After Throwing Advice Method에는 JoinPoint 인터페이스의 매개변수 외에 Exception 클래스의[주석]
	// => 스프링 컨테이너는 Exception 클래스의 매개변수에 타겟메소드에서 발생된 예외(Exception)[주석]
	...
	// => 타겟메소드 관련 정보를 ProceedingJoinPoint 인터페이스의 매개변수로 제공받아 Around Advice 
	//Method에서 사용
