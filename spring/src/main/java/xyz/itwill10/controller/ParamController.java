...
public class ParamController {
	...
	public String result(HttpServletRequest request) throws UnsupportedEncodingException {
		...
		String food=request.getParameter("food"); //JSP 문서의 name 속성에 담긴 value를 가져올 수 있음
	...
	*/
	...
	//클라이언트의 모든 요청에 대한 리퀘스트 메세지 몸체부에 저장되어 전달되는 값에 대한
	...
	*/
	...
	// => required 속성값을 [true]로 설정하면 매개변수의 이름과 전달값의 이름을 동일하게 작성하여
	//매개변수에 전달값이 저장되도록 설정
