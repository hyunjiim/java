...
public class SessionController {
	...
	public String view(@RequestParam(defaultValue = "abc123") String id, Model model) {
		...
		// => hewon_view에서만 사용 가능
		// => @SessionAttributes 어노테이션을 사용하면 모든 요청처리 메소드와 view에서 사용 가능
	...
	public String update(@RequestParam(defaultValue = "abc123") String id, Model model) {
		...
		return "hewon_update"; //hewon 객체에 저장된 값을 입력태그의 초기값으로 사용
	}
	*/
	...
	public String update() {
		return "hewon_update"; //어노테이션을 통해 hewon 객체를 사용할 수 있음
	}
