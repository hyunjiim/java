...
public class RedirectController {
	...
	public String forward(Model model) {
		...
		//포워드 이동 : 서버 내부에서 현재 웹프로그램의 스레드를 다른 웹프로그램으로 이동하여 응답처리
	...
	public String redirect() {
		...
		//실행결과를 제공받아 응답 처리
		// => 클라이언트의 요청 URL 주소는 병경되지만 Request Scope 속성값 사용 불가능
	...
	*/
	...
	public String redirect(RedirectAttributes attributes) {
		//RedirectAttrivutes.addFlashAttribute(String attributeName, Object attributeValue)
