...
//2. Mybatis 프레임워크의 환경설정파일 작성
// => [src/main/webapp] 폴더에 작성해야만 스프링 컨테이너(WebApplicationContext 객체)가
//Mybatis 프레임워크의 환경설정파일을 읽어 SqlSessionFactory 클래스를 Spring Bean으로 등록 처리
// => [src/main/java] 또는 [src/main/resources] 폴더에서 Mybatis 프레임워크의 환경설정파일 작성
