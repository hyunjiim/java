...
//@WebAppConfiguration : 스프링 컨테이너를 ApplicationContext 객체가 아닌 WebApplicationContext 객체를
//사용할 수 있도록 설정하기 위한 어노테이션
@WebAppConfiguration
...
public class StudentServiceTest {
	...
	public void testAddStudent() {
		...
		student.setNo(6000);
		student.setName("로빈훗");
		student.setPhone("010-6561-1542");
		student.setAddress("서울시 중랑구");
		student.setBirthday("2000-09-09");
		*/
		//Student 클래스의 builder() 메소드를 호출하여 StudentBuilder 객체를 제공받아
		//필드 관련 메소드로 필드값을 변경하여 build() 메소드로 Student 객체를 반환받아 생성
