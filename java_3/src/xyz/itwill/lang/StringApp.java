...
//=>String 객체는 문자열을 내부적으로 byte 배열로 처리하여 배열요소에 문자를 하나씩 저장
public class StringApp {
	public static void main(String[] args) {
		//문자열은 ""기호를 사용하여 표현하면 자동으로 메소드의 메소드영역(MethodArea)에 String 객체를 생성하여 String 객체에 문자열 저장
		...
		System.out.println("========================================================");
		//""기호로 String 객체를 표현할 경우 동일한 문자열의 String 객체는 생성하지 않고 기존에 생성된 String 객체를 재활용하여 사용
		String str2="ABC"; //기존의 String 객체
		...
		System.out.println("========================================================");
		//new 연산자로 생성자를 호출하여 String 객체를 생성하면 메모리의 힙영역(HeapArea)에 새로운 String 객체를 생성
		...
		System.out.println("========================================================");
		//String.equals(String str): String 객체에 저장된 문자열과 매개변수로 전달받은 문자열을 비교하여 다른 경우[false]를 반환하고 같은 경우[true]를 반환하는 메소드
		...
		System.out.println("========================================================");
		//String.equalsIgnoreCase(String str): String 객체에 저장된 문자열과 매개변수로 전달받은 문자열을 비교하여 다른 경우[false]를 반환하고 같은 경우[true]를 반환하는 메소드
		//=>비교 문지열이 영문자인 경우 대소문자를 구분하지 않고 비교
		...
		System.out.println("========================================================");
		//String.compareTo(String str): String 객체에 저장된 문자열과 매개변수로 전달받은 문자열을 비교하여 String 객체의 문자열이 큰 경우 양수를 반환하고 매개변수로 전달받은 문자열이 큰 경우 음수를 반환하며 같은 경우 0을 반환하는 메소드
		...
		for(byte ch : array) {
			System.out.print((char)ch); //byte배열의 요소값(정수값)을 문자로 형변환하여 출력
		}
		System.out.println();
		System.out.println("========================================================");
		String str5="ABCDEFG";
...
//		String.length():String 객체에 저장된 문자열의 문자 갯수를 반환하는 메소드
		...
		//String.replace(String regEx, String replacement): String 객체에 저장된 문자열에서 검색 문자열(정규표현식)을 찾아 치환 문자열로 변경하여 반환하는 메소드
		...
		System.out.println("========================================================");
		//String.substring(int beginIndex, int endIndex): String 객체에 저장된 문자열에서 시작첨자(문자포함)에서 종료첨자(문자미포함)까지의 문자열을 분리하여 반환하는 메소드
...
//		System.out.println("전화번호 뒷부분: "+str9.substring(9, 13));
		...
		System.out.println("전화번호 뒷부분: "+str9.substring(9, 13));
		System.out.println("========================================================");
//		String.valueOf(Object obj): 매개변수로 전달된 모든 자료형의 값을 문자열(String 객체)로 변환하여 반환하는 메소드
		//String numString=String.valueOf(100);
		String numString=100+""; //""+값 또는 값+"" 형식으로 모든 자료형의 값을 문자열과 결합하여 문자열로 사용 가능
