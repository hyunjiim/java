...
public class StudentManager {
	...
	// 학번을 전달받아 저장매체에 저장된 학생정보의 학번과 비교하여 같은 학번의 학생정보가 저장된 고유값(Index)를 반환하는 메소드
	...
	// 학생정보를 전달받아 저장매체에 삽입하고 삽입결과를 boolean으로 반환하는 메소드
	// =>false 반환: 삽입 실패, true 반환: 삽입 성공
	// =>매개변수로 전달받은 학생정보의 학번이 저장매체에 저장된 기존 학생정보의 학번과 중복될 경우 삽입 실패 처리
	...
	// 학번을 전달받아 저장매체에 저장된 학생정보를 삭체하고 삭제결과를 논리값으로 반환하는 메소드
	...
	//학생정보를 전달받아 저장매체에 저장된 학생정보를 검색하여 반환하는 메소드
